...
export function CrewPage() {
  ...
  return (
    <section className="relative flex h-full w-full justify-center px-6 pt-[112px] md:px-10 md:pt-[136px] 1440:pt-[184px]">
      ...
      <div className="h-full w-full space-y-6 md:min-w-[688px] 1440:max-w-[1110px]">
        <p className="page-title 1440:title-5 w-full md:text-[20px] md:leading-[24px] md:tracking-[3px]">
        ...
        <div className="flex flex-col items-center space-y-8 1440:flex-row 1440:items-center 1440:space-x-8 1440:space-y-0">
          <div className="flex h-[319px] flex-col items-center pt-10 md:max-w-[512px] 1440:h-[734px] 1440:max-w-none 1440:flex-1 1440:space-y-10 1440:pt-0">
            <div className="flex flex-col items-center 1440:flex-1 1440:justify-center">
              ...
              <h1 className="crew-name 1440:title-3 mb-6 md:text-[40px] md:leading-[46px]">
                {data.name}
              </h1>
              <p className="crew-introduction mb-6 md:text-[16px] 1440:mb-0 1440:text-start 1440:text-[18px]">
                {data.introduction}
              </p>
            </div>
          ...
          <div className="relative flex h-[350px] w-full items-center justify-center md:h-auto md:items-start 1440:h-[734px] 1440:flex-1 1440:items-center">
            <img
              className="h-[340px] w-[271px] object-contain md:h-[560px] md:w-[446.7px] 1440:h-[676px] 1440:w-[540px]"
              src={data.image}
              alt="crew image"
            />
